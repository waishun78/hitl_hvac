...
# Reading the 'cricket_scores.csv' dataset from the CSV file using the Pandas library
# Note that the 7th, 11th, 14th and 17th inputs are anomalies in this dataset
...
isolation_forest_ML_model.fit(dataset[['Scores']])
...
dataset['anomalies_scores'] = isolation_forest_ML_model.decision_function(dataset[['Scores']])
...
dataset['anomaly'] = isolation_forest_ML_model.predict(dataset[['Scores']])
print(dataset)
